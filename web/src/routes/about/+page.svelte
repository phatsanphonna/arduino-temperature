<svelte:head>
	<title>เกี่ยวกับ | Arduino Temperature Sensor</title>
</svelte:head>
...
<div class="w-full">
	...
	<p class="leading-7 [&:not(:first-child)]:mt-6">
		Source code ของโปรเจคนี้สามารถดูได้ที่ <a
			target="_blank"
			class="underline"
			href="https://github.com/phatsanphonna/arduino-temperature">GitHub</a
		>
	</p>
